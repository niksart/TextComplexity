...
data Lemma = Lemma String (Set.Set String) deriving (Show)
...
getMapFromLemma :: Lemma -> (Map.Map String String)
getMapFromLemma (Lemma indexLemma derivedLemmas) = Map.fromSet (\k -> indexLemma) derivedLemmas
